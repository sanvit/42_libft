...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/02/01 00:37:46 by jaewokim          #+#    #+#              #
#    Updated: 2022/02/01 00:37:51 by jaewokim         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strnstr.c ft_isascii.c ft_memmove.c ft_strdup.c ft_strnstr.c ft_split.c
